   ...
   <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top" style="border-bottom-color: 10px solid orange">
    ...
    <div class="container" style="padding-top: 30px">
      ...
      <ol class="breadcrumb">
       ...
       <center>
        <div>
      <img class="img-fluid" src="https://i2.wp.com/burbex.org/wp-content/uploads/2014/10/13162384504_96581bd99f_o.jpg?resize=474%2C268">
      </div>
      </center>
      <br>

      <div class="bg-light"><p>A key part of any mobile phone specification is its operating frequency bands. The supported frequency bands determine whether a certain handset is compatible with a certain network carrier.

      Beside the mobile phone specifications, GSMArena is happy to also provide you with its own country-based frequency band directory. It's not operator-specific and it's helpful if you are choosing a handset to use in your home country or if you are making sure your phone will work in the country you are heading to.</p></div>

    <div class="breadcrumb">
      
        Currently we only have specifications for&nbsp<b>Pakistan</b> 
    ...
    <thead class="thead-light">
      <tr>
        <th colspan="2"><h3><b>Pakistan</b></h3></th>
        
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>2G capabilities</td>
        <td><b>GSM 900, GSM 1800</b></td>
      </tr>
      <tr>
        <td>3G capabilities</td>
        <td><b>UMTS 850, UMTS 900, UMTS 2100</b></td>
      </tr>
      <tr>
        <td>4G capabilities</td>
        <td><b>LTE 850, LTE 1800</b></td>
      </tr>
    </tbody>
  </table>
    </div>
    ...
    <div class="bg-light">
      <p>
        <b>2G</b>, first introduced in 1992, is the second-generation of cellular telephone technology and the first to use digital encryption of conversations. 2G networks were the first to offer data services and SMS text messaging, but their data transfer rates are lower than those of their successors. 
      </p>
      <p>
        <b>3G</b> networks succeed 2G ones, offering faster data transfer rates and are the first to enable video calls. This makes them especially suitable for use in modern smartphones, which require constant high-speed internet connection for many of their applications. 
      </p>
      <p>
        <b>4G</b> is the fourth generation of mobile phone communications standards. It is a successor of the 3G and provides ultra-broadband internet access for mobile devices. The high data transfer rates make 4G networks suitable for use in USB wireless modems for laptops and even home internet access.
      </p>
    </div>
    <hr>
