  ...
  <body>
    ...
    <br><br>
      ...
      <ol class="breadcrumb">
       ...
       <center>
      	<div>
      <img class="img-fluid" src="https://www.webrezpro.com/wp-content/uploads/2013/02/p-faq.jpg">
      </div>
      </center>
      <br>
      ...
      <div class="mb-4" id="accordion" role="tablist" aria-multiselectable="true">
        <div class="card">
          <div class="card-header" role="tab" id="headingOne">
            <h5 class="mb-0">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Do you sell phones?</a>
            </h5>
          </div>

          <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
            <div class="card-body">
             NO, Mobile Arena do not sell any phones and other products. Our sole purpose is to give our viewers correct information about the device they are searching.
            </div>
          </div>
        </div>
        <div class="card">
          <div class="card-header" role="tab" id="headingTwo">
            <h5 class="mb-0">
              <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
              	Do you repair phone or tablets?
              </a>
            </h5>
          </div>
          <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
            <div class="card-body">
              NO, Mobile Arena do not upgrade or repair phones/tablets. We merely provide information about mobile phones.
            </div>
          </div>
        </div>
        <div class="card">
          <div class="card-header" role="tab" id="headingThree">
            <h5 class="mb-0">
              <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">How can I find out if a particular device will work in my country?</a>
            </h5>
          </div>
          <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree">
            <div class="card-body">
              Currently we only provide information about the devices that work in Pakistan. For more information, you can vist our coverage page.
            </div>
          </div>
        </div>
         <div class="card">
          <div class="card-header" role="tab" id="headingFour">
            <h5 class="mb-0">
              <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Do you have any promotional offers?</a>
            </h5>
          </div>

          <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour">
            <div class="card-body">
            NO, as our purpose is not selling phones we just give accurate information about the devices on our site, so there is no point of having any promotional offers
            </div>
          </div>
        </div>
         <div class="card">
          <div class="card-header" role="tab" id="headingFive">
            <h5 class="mb-0">
              <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Do you have any social media pages?</a>
            </h5>
          </div>

          <div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="headingFive">
            <div class="card-body">
            Yes, you can find us on facebook, twitter, instagram and linkedIn.
            </div>
          </div>
        </div>
      </div>
