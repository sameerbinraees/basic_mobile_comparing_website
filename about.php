...
<h1 class="mt-4 mb-3">About
  ...
  <div class="card" style="max-width:400px">
    <img class="card-img-top zoom" src="hassaan.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">Cheema</h4>
      <p class="card-text">The most senior web developer in the world</p>
      <a href="hassaan/resume.php" target="_blank" class="btn btn-primary">See Profile</a>
    </div>
    </div>
  </center>
  </div>
<div class="col-lg-6 mb-4">
  <center>
  <div class="card" style="max-width:400px">
    <img class="card-img-top zoom" src="sameer.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">Sammy</h4>
      <p class="card-text">The most junior web developer in the world</p>
      <a href="sameer/assignment2.php" target="_blank" class="btn btn-primary">See Profile</a>
    </div>
    </div>
  </center>
  </div>
