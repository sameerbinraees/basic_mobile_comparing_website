...
$(document).ready(function(){
  ...
  <body>
     ...
     <div class="container" >
    <div> <img src="https://upload.wikimedia.org/wikipedia/commons/d/de/Phonebox_logo_new.png" style="width: 100% ; padding-top: 30px"> </div>
    <div class="row latest wow fadeInUp" data-wow-delay="0.4s " data-wow-duration="1.4s" >
     <div class="col-lg-10 mb-4 " style=" background-color: #353942;">
     <?php
     $p=$_REQUEST["p"];
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) { 
      ...
      <div class="col-lg-2  mb-4" style=" background-color: black;padding-top: 15px; padding-bottom: 15px">      
      <i class="fa fa-facebook" style="color: white;padding-right: 20px;padding-left: 10px"></i>
    <i class="fa fa-twitter" style="color: white; padding-right: 20px" ></i>
  <i class="fa fa-google-plus" style="color: white; padding-right: 20px"></i>
    <i class="fa fa-linkedin" style="color: white; padding-right: 20px" ></i>
    </div>

    
         <div class="col-lg-4  mb-4" style=" height: 350px;">
           <center><img src="<?php echo "" .$row['url']; ?> " class="img-fluid" style="height: 350px;width: 350px "></center>
        </div>
        ...
        <div class="col-lg-8  mb-4" style=" height: 350px;  padding-bottom: 50px">
 ...
 <div class="col-lg-6  mb-4"  > 
         <a href="compare.php?q=<?php echo "" .$row['name']; ?>" class=" btn btn-primary" style="padding-right: 10px; width: 100%"> COMPARE </a>
      </div>
...
$conn->close();
?>
<div class="col-lg-2 col-md-12 mb-4" style="height: 720px;padding-top: 20px;padding-bottom: 20px;margin-top: 20px; border-radius: 10px">
<div class="col-lg-12 papa" style="height: 720px;padding-top: 20px;padding-bottom: 20px;margin-top: 20px; border-radius: 10px">
...
<div class="col-lg-12  mb-4" > <form action="/php/tags/php_form_tag_action.cfm" method="post" style="padding-top: 40px">
<h2><b>COMMENT SECTION</b></h2>
<div>
<br>
<textarea name="comments" id="comments" style="width: 100%; font-family:sans-serif;font-size:1.2em;">
Hey... say something!
</textarea>
</div>
<input type="submit" value="Submit" align="right">
<div name="comments" id="comments" style="width: 100%;padding: 10px;margin-top: 10px; border:1px solid black; font-family:sans-serif;font-size:1.2em;">
Wants to buy I phone 8 + urgently. Damage or bad condition or broken conditions but unlock. Plz call 03008205940 
</div>
<div name="comments" id="comments" style="width: 100%;padding: 10px;margin-top: 10px; border:1px solid black; font-family:sans-serif;font-size:1.2em;">
AoA, i want to sale my iPhone 8 plus 64 GB, Gold color in excellent condition just like new with original charger and data cable. contact 03338466685 (Lahore)
</div>
<div name="comments" id="comments" style="width: 100%;padding: 10px;margin-top: 10px; border:1px solid black; font-family:sans-serif;font-size:1.2em;">
iPhone 8 Plus, golden colour, 64 gb, box not yet open. Buyer will open the box. Demand 90 thousand. WhatsApp only. M Aslam. 0333-3503561. Karachi 
</div>
...
<div class="footer-info-single">
  ...
  <ul class="list-unstyled">
    ...
    <li><a href="compare.php" title=""><i class="fa fa-angle-double-right"></i>Comparison</a></li>
...
<div class="footer-info-single">
  ...
  <ul class="list-unstyled">
    ...
    <li><a href="compare.php" title=""><i class="fa fa-angle-double-right"></i> Features</a></li>
